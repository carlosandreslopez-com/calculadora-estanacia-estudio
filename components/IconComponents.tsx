...
export const UploadIcon: React.FC<IconProps> = ({ className }) => (
  <svg className={className} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 16">
    {/* Fix: Corrected SVG attribute casing from strokeLineCap/Join to strokeLinecap/join */}
...
export const CalculatorIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
        {/* Fix: Corrected SVG attribute casing from strokeLineCap/Join to strokeLinecap/join */}
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 15.75V18m-7.5-6.75h.008v.008H8.25v-.008zm0 2.25h.008v.008H8.25V11.25zm0 2.25h.008v.008H8.25v-.008zm0 2.25h.008v.008H8.25V15.75zM21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
    </svg>
);
